...
# 添加 argon 主题（ranqingwen 改版）
rm -rf feeds/luci/themes/luci-theme-argon
rm -rf feeds/luci/applications/luci-app-argon-config
git clone https://github.com/ranqingwen/luci-theme-argon.git package/luci-theme-argon
git clone https://github.com/ranqingwen/luci-theme-argon.git -b argon-config package/luci-app-argon-config
